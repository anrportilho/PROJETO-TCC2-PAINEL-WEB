...
<div class="p-a white lt box-shadow">
	<div class="row">
	<div class="col-xs-3">
  <form  action="gov-uf.php" method="get" enctype="multipart/form-data">
            </div>
            <div class="col-xs-3">
            ...
            <div class="col-xs-3">
                <select name="periodo" class="form-control" required="required">
                    <option value="">Selecione o período de encerramento</option>
                    <option value="7">Encerrados nos últimos 7 dias</option>
                    <option value="15">Encerrados nos últimos 15 dias</option>
                    <option value="30">Encerrados nos últimos 30 dias</option>
                    <option value="60">Encerrados nos últimos 45 dias</option>
	    ...
	    <div class="col-md-12 col-xl-12">
	        <div class="box">
	          <div class="box-header">
	            <h3>INDICES POR UF - <?php if ($idFornecedor=="20140206"){
                echo "MÓVEL";
              }
	          ...
	          <div class=" b-t">
                ...
                <div class="box">
                    <?php
                      $sql = "SELECT * from tbluf WHERE clienteId LIKE '".$idFornecedor."' and periodo = $periodo and uf LIKE '".$uf."' order by UF asc";
                 ...
                 <?php
                        ...
                        <td><strong><?php echo $row["uf"]?></strong></td>                        
